...
var NavBar = React.createClass({
  ...
  handleBack:function(){
    ...
    var itemDisplay_info = (this.state.UserStore.user.accout && this.state.UserStore.user.password) ? '' : 'hidden' ;
		return(
			  <Navbar brand={ <div><img className="back" src="./images/back.png" onClick={this.handleBack} /><img className="home" src="./images/home.png" onClick={this.handleBack} /><Link to="home" className="logo" >微同济 <span className={classnames(itemDisplay_info,"userInfo") } >   您好:{this.state.UserStore.user.accout}</span></Link> </div>} inverse fixedTop fluid toggleNavKey={0}>
